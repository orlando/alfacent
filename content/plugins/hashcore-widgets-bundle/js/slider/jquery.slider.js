...
jQuery( function($){
    ...
    var playSlideVideo = hashcoreSlider.playSlideVideo = function(el) {
    ...
    var pauseSlideVideo = hashcoreSlider.pauseSlideVideo = function(el) {
        $(el).find('video').each(function(){
    ...
    var setupActiveSlide = hashcoreSlider.setupActiveSlide = function(slider, newActive, speed){
