 ...
 *
 * @author Greg Priday <greg@>
 * @copyright Copyright (c) 2011, Greg Priday
 * @license GPL <http://www.gnu.org/copyleft/gpl.html>
 */
class HashCore_Widgets_Color_Object extends HashCore_Widgets_Color{
	private $changed;
	 ...
	 */
	public static function distance(HashCore_Widgets_Color_Object $c1, HashCore_Widgets_Color_Object $c2){
		return sqrt(
