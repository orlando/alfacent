...
class HashCore_Widget_Meta_Box_Manager extends HashCore_Widget {

	const POST_META_KEY = 'hashcore-widgets-post-meta';
	 ...
	 *
	 * @return HashCore_Widget_Meta_Box_Manager
	 */
	static function single(){
		static $single = false;
		if( empty($single) ) $single = new HashCore_Widget_Meta_Box_Manager();
	...
	public function __construct() {
		parent::__construct(
			...
			__('HashCore Meta Box Manager', 'hashcore-widgets-bundle'),
			array(
				'has_preview' => false,
				'help' => 'https:///docs/widgets-bundle/advanced-concepts/widget-post-meta-box-forms/'
			),
			array(),
			array()
		);
	...
	public function add_meta_boxes( $post_type ) {
		...
		if ( !empty( $this->form_options ) ) {
			add_meta_box(
				'hashcore-widgets-meta-box',
				__( 'Widgets Bundle Post Meta Data', 'hashcore-widgets-bundle' ),
