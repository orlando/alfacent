 ...
 */
function hashcore_widgets_get_attachment_image_src( $attachment, $size, $fallback = false ){
...
function hashcore_widgets_get_attachment_image( $attachment, $size, $fallback ){
	if( !empty( $attachment ) ) {
		return wp_get_attachment_image( $attachment, $size );
	}
	else {
		$src = hashcore_widgets_get_attachment_image_src( $attachment, $size, $fallback );
