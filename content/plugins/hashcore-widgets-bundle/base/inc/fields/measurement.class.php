...
/**
 * Class HashCore_Widget_Field_Measurement
 */
class HashCore_Widget_Field_Measurement extends HashCore_Widget_Field_Text_Input_Base {

	protected function get_input_classes() {
		$input_classes = parent::get_input_classes();
		$input_classes[] = 'hashcore-widget-input-measurement';
	...
	protected function render_after_field( $value, $instance ) {
		...
		<select class="sow-measurement-select-unit"
			...
			<?php foreach ( hashcore_widgets_get_measurements_list() as $measurement ):?>
	...
	protected function sanitize_field_input( $value, $instance ) {
		...
		if( isset( $instance[ $unit_name ] ) ) {
			$units = hashcore_widgets_get_measurements_list();
