...
/**
 * Class HashCore_Widget_Field_Checkbox
 */
class HashCore_Widget_Field_Checkbox extends HashCore_Widget_Field_Base {
	...
	protected function render_field( $value, $instance ) {
		...
		<label for="<?php echo esc_attr( $this->element_id ) ?>">
			<input type="checkbox" name="<?php echo esc_attr( $this->element_name ) ?>" id="<?php echo esc_attr( $this->element_id ) ?>"
			       class="hashcore-widget-input" <?php checked( !empty( $value ) ) ?> />
