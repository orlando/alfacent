 ...
 *
 * Class HashCore_Widget_Field_Editor
 */
class HashCore_Widget_Field_Editor extends HashCore_Widget_Field_Text_Input_Base {
	/**
	...
	protected function get_input_classes() {
		...
		$input_classes[] = 'hashcore-widget-input-editor';
