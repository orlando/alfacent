 ...
 *
 * Class HashCore_Widget_Field_Text
 */
abstract class HashCore_Widget_Field_Text_Input_Base extends HashCore_Widget_Field_Base {
	...
	protected function get_input_classes() {
		return array( 'widefat', 'hashcore-widget-input' );
	}
