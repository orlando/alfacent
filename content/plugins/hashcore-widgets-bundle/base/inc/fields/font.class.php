...
/**
 * Class HashCore_Widget_Field_Font
 */
class HashCore_Widget_Field_Font extends HashCore_Widget_Field_Base {

	protected function render_field( $value, $instance ) {
		static $widget_font_families;
		if( empty($widget_font_families) ) {

			$widget_font_families = hashcore_widgets_font_families();
		}
		?>
		<div class="hashcore-widget-font-selector hashcore-widget-field-subcontainer">
			<select name="<?php echo esc_attr( $this->element_name ) ?>" id="<?php echo esc_attr( $this->element_id ) ?>" class="hashcore-widget-input">
				<option value="default" selected="selected"><?php esc_html_e( 'Use theme font', 'hashcore-widgets-bundle' ) ?></option>
