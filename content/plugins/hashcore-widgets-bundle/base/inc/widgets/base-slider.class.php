...
abstract class HashCore_Widget_Base_Slider extends HashCore_Widget {
	...
	function control_form_fields(){
		return array(
			'speed' => array(
				'type' => 'number',
				'label' => __('Animation speed', 'hashcore-widgets-bundle'),
				'description' => __('Animation speed in milliseconds.', 'hashcore-widgets-bundle'),
				'default' => 800,
			),

			'timeout' => array(
				'type' => 'number',
				'label' => __('Timeout', 'hashcore-widgets-bundle'),
				'description' => __('How long each frame is displayed for in milliseconds.', 'hashcore-widgets-bundle'),
				'default' => 8000,
			),

			'nav_color_hex' => array(
				'type' => 'color',
				'label' => __('Navigation color', 'hashcore-widgets-bundle'),
				'default' => '#FFFFFF',
			),

			'nav_style' => array(
				'type' => 'select',
				'label' => __('Navigation style', 'hashcore-widgets-bundle'),
				'default' => 'thin',
				'options' => array(
					'ultra-thin' => __('Ultra thin', 'hashcore-widgets-bundle'),
					'thin' => __('Thin', 'hashcore-widgets-bundle'),
					'medium' => __('Medium', 'hashcore-widgets-bundle'),
					'thick' => __('Thick', 'hashcore-widgets-bundle'),
					'ultra-thin-rounded' => __('Rounded ultra thin', 'hashcore-widgets-bundle'),
					'thin-rounded' => __('Rounded thin', 'hashcore-widgets-bundle'),
					'medium-rounded' => __('Rounded medium', 'hashcore-widgets-bundle'),
					'thick-rounded' => __('Rounded thick', 'hashcore-widgets-bundle'),
				)
			),

			'nav_size' => array(
				'type' => 'number',
				'label' => __('Navigation size', 'hashcore-widgets-bundle'),
				'default' => '25',
			),
		);
	}
	...
	function video_form_fields(){
		return array(
			'file' => array(
				'type' => 'media',
				'library' => 'video',
				'label' => __('Video file', 'hashcore-widgets-bundle'),
			),

			'url' => array(
				'type' => 'text',
				'sanitize' => 'url',
				'label' => __('Video URL', 'hashcore-widgets-bundle'),
				'optional' => 'true',
				'description' => __('An external URL of the video. Overrides video file.', 'hashcore-widgets-bundle')
			),

			'format' => array(
				'type' => 'select',
				'label' => __('Video format', 'hashcore-widgets-bundle'),
				'options' => array(
					'video/mp4' => 'MP4',
					'video/webm' => 'WebM',
					'video/ogg' => 'Ogg',
			...
			'height' => array(
				'type' => 'number',
				'label' => __( 'Maximum height', 'hashcore-widgets-bundle' )
			),
