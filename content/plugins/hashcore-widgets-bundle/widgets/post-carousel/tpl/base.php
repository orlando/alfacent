...
<?php if($posts->have_posts()) : ?>
	<div class="sow-carousel-title">
		...
		<a href="#" class="sow-carousel-next" title="<?php esc_attr_e('Next', 'hashcore-widgets-bundle') ?>"></a>
		<a href="#" class="sow-carousel-previous" title="<?php esc_attr_e('Previous', 'hashcore-widgets-bundle') ?>"></a>
	</div>
