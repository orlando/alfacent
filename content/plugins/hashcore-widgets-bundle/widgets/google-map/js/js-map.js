/**
 * (c) HashCore, freely distributable under the terms of the GPL 2.0 license.
 */

var HashCoreGoogleMap = function($) {
	return {
...
function soGoogleMapInitialize() {
    new HashCoreGoogleMap(window.jQuery).loadMaps();
}

jQuery(function ($) {
    if (window.google && window.google.maps) {
        new HashCoreGoogleMap($).loadMaps();
    } else {
