...
class HashCore_Widget_Video_Widget extends HashCore_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'host_type' => array(
					'type' => 'radio',
					'label' => __( 'Video location', 'hashcore-widgets-bundle' ),
					'default' => 'self',
					'options' => array(
						'self' => __( 'Self hosted', 'hashcore-widgets-bundle' ),
						'external' => __( 'Externally hosted', 'hashcore-widgets-bundle' ),
					),
				...
				'video' => array(
					...
					'fields' => array(
						'self_video' => array(
							'type' => 'media',
							'fallback' => true,
							'label' => __( 'Select video', 'hashcore-widgets-bundle' ),
							'description' => __( 'Select an uploaded video in mp4 format. Other formats, such as webm and ogv will work in some browsers. You can use an online service such as <a href="http://video.online-convert.com/convert-to-mp4" target="_blank">online-convert.com</a> to convert your videos to mp4.', 'hashcore-widgets-bundle' ),
							'default'     => '',
							'library' => 'video',
							'state_handler' => array(
						...
						'self_poster' => array(
							'type' => 'media',
							'label' => __( 'Select cover image', 'hashcore-widgets-bundle' ),
							'default'     => '',
							'library' => 'image',
							'state_handler' => array(
								'video_type[self]' => array('show'),
				...
				'playback' => array(
					'type' => 'section',
					'label' => __('Video Playback', 'hashcore-widgets-bundle'),
					'fields' => array(
						'autoplay' => array(
							'type' => 'checkbox',
							'default' => false,
							'label' => __( 'Autoplay', 'hashcore-widgets-bundle' )
						),
						'oembed' => array(
							'type' => 'checkbox',
							'default' => true,
							'label' => __( 'Use oEmbed', 'hashcore-widgets-bundle' ),
							'description' => __( 'Always use the embedded video rather than the MediaElement player.', 'hashcore-widgets-bundle' ),
							'state_handler' => array(
								'video_type[external]' => array('show'),
								'video_type[self]' => array('hide'),
							)
...
hashcore_widget_register( 'video', __FILE__, 'HashCore_Widget_Video_Widget' );
